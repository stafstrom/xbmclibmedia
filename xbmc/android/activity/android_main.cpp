...
extern "C" JNIEXPORT jint JNI_OnLoad(JavaVM *vm, void *reserved)
{
  ...
  jclass cMain = env->FindClass("org/xbmc/xbmclibmedia/Main");
  if(cMain)
  {
  ...
  jclass cBroadcastReceiver = env->FindClass("org/xbmc/xbmclibmedia/XBMCBroadcastReceiver");
  ...
  jclass cFrameAvailableListener = env->FindClass("org/xbmc/xbmclibmedia/XBMCOnFrameAvailableListener");
